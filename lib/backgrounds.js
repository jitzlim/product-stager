...
const ASPECT_RATIO_LABELS = {
  '9:16':  'Portrait orientation (9:16)',
  '1:1':   'Square format (1:1)',
  '4:3':   'Landscape orientation (4:3)',
  '16:9':  'Wide landscape orientation (16:9)',
}

export function buildPrompt(handModel, backgroundId, customInstructions, aspectRatio = '9:16') {
  ...
  const orientationLabel = ASPECT_RATIO_LABELS[aspectRatio] || ASPECT_RATIO_LABELS['9:16']
...
Final image must look indistinguishable from real UGC posted by an everyday customer. ${orientationLabel}.`
